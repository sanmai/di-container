...
- Constructor-only dependency injection; the container intentionally avoids complex features, such as property/method and variadic/composite types injection in constructors. This approach promotes cleaner, more testable class designs.
